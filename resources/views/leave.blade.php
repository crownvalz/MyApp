...
<div class="max-w-full mx-auto p-6 bg-white rounded-lg shadow-lg overflow-x-auto font-medium text-[17px]">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-center gap-4 mb-6">
        ...
        <div class="flex w-full sm:w-auto items-center gap-4">
            ...
            <button data-modal-id="Modal1" class="open-modal bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-md text-sm font-medium flex items-center gap-2">
